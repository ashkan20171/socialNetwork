...
function random_string($len=5, $str='')  
 ...
 $image=imagecreatefrompng("../img/Untitled.png");
 ...
 $font1 = 'tahoma.ttf';
 $font2 = '../fonts/'.rand(1,1).'.ttf';
 $font3 = '../fonts/'.rand(1,1).'.ttf';
 $font4 = '../fonts/'.rand(1,1).'.ttf';
 $font5 = '../fonts/'.rand(1,1).'.ttf';
 ...
 imagettftext($image, $size2, $angle2, 30, $y_pos2, $textColor2, $font1, $letter2);
 imagettftext($image, $size3, $angle3, 55, $y_pos3, $textColor3, $font1, $letter3);
 imagettftext($image, $size4, $angle4, 75, $y_pos4, $textColor4, $font1, $letter4);
 imagettftext($image, $size5, $angle5, 92, $y_pos5, $textColor5, $font1, $letter5);
