                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <tr class="odd gradeX">
							  ...
							  $q="select * from pardakhtiha";
							  if(isset($_POST['str']))
							  $q="select * from pardakhtiha where email like'%".checkInput($_POST['str'])."%' or tarikh like '%".checkInput($_POST['str'])."%' or transid like '%".checkInput($_POST['str'])."%' or idget like '%".checkInput($_POST['str'])."%' or mablagh=".checkInput($_POST['str']).")";
