                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <tr class="odd gradeX">
							  ...
							  $q="select email,tarikh, count(email) as tedad,count(email)*150 as mablagh from sentsms group by email,tarikh";
							  ...
							  <td>'.$row['tarikh'].'</td>
							  <td>'.$row['tedad'].'</td>
                              <td class="hidden-phone">'.$row['mablagh'].'</td>
